...
{
    internal class UserDestinationWriter
    {
        ...
        private void MoveDataToMainTable(Mapping mapping, SqlTransaction sqlTransaction)
        {
            ...
            {
                throw SqlDestinationWriter.GetMoveDataToMainTableException(ex, _sqlCommand, mapping, "TempTableForBulkImport" + mapping.GetId(), insertColumns, tempTableName, destinationTableName);
            }
        }
        private static bool HasIdentity(Mapping mapping)
        {
